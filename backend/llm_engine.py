...
def ask_real_ai(question, data):
    ...
    try:
        # Keep the web request responsive. Gemini's client timeout is in
        # milliseconds; after the short deadline DataKite falls back to the
        # deterministic pandas analyst instead of making the user wait minutes.
